...
As you can observe from above
    """
    assert (code_extract(test_simple) == r"""from numpy import sin, cos, tan
...
"""
    assert (
        code_extract(test_empty_lines) == r"""from numpy import sin, cos, tan
def f(x):
    return tan(x)""")
...
```
"""
    assert (sanitize(icode) == r"""import numpy as np
from numpy import sin, cos
def f(x):
    return np.tan(x)
def g(x):
...
```
"""
    assert (sanitize(icode, "g") == r"""import numpy as np
from numpy import sin, cos
def f(x):
    return np.tan(x)
def g(x):
