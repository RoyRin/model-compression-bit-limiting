...
def test_code_coverage(identifier: str, code: str, inputs: List[List[Any]],
                       entry_point: str):
...
def collect_coverage_info(coverage_dir: str,
    ...
    for task_id in track(task_ids, description="Testing gt coverage..."):
        coverage_cache_path = os.path.join(coverage_dir,
                                           f"{to_path(task_id)}.pkl")
